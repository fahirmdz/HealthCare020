...
{
    public class ZdravstvenoStanjeService : BaseCRUDService<TwoFieldsDto, TwoFieldsResourceParameters, ZdravstvenoStanje, ZdravstvenoStanjeUpsertDto, ZdravstvenoStanjeUpsertDto>
    {
